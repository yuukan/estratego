<?php namespace App\Http\Controllers;
	...
	class AdminCsTipoInvitadoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "cs_tipo_invitado";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Tipo Invitado","name"=>"tipo"];
